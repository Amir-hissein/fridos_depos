...
export default function CameraScreen() {
  ...
  const insightsFeature = {
    ...
    text: t('scan.camera.permission.features.insights'),
  };
  const privacyFeature = {
    icon: 'lock-closed-outline' as IconName,
    text: t('scan.camera.permission.features.privacy'),
  };
    ...
    <View style={styles.container}>
        ...
        <View style={styles.maskMiddle}>
          ...
          <View style={styles.window}>
            <View style={styles.scanClip}>
              {!analyzing && (
                <Animated.View
                  style={[styles.scanBeam, { transform: [{ translateY: scanLineAnim }] }]}
                >
                  <LinearGradient
        ...
        <View style={styles.maskRowBottom}>
          <View style={styles.hintPill}>
            ...
            <Text style={styles.hintText}>
              {isMeal ? t('scan.camera.hints.meal') : t('scan.camera.hints.fridge')}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.headerBar, { paddingTop: Math.max(insets.top, 12) + 4 }]}>
        ...
        <Text style={styles.headerTitle}>
          {isMeal ? t('scan.camera.headers.meal') : t('scan.camera.headers.fridge')}
        </Text>
        <PressableScale
          haptic="light"
        ...
        >
          <Ionicons
            ...
            size={20}
            color={torch ? colors.scanBg : colors.white}
          />
        </PressableScale>
      </View>
      ...
      {/* Effet d'obturateur (flash blanc) */}
      <Animated.View pointerEvents="none" style={[styles.shutter, { opacity: shutterAnim }]} />
        ...
        <View style={styles.analyzeOverlay}>
          <View style={styles.analyzeCard}>
            ...
            <Text style={styles.analyzeDesc}>
              {isMeal
                ? t('scan.camera.analyzing.desc.meal')
                : t('scan.camera.analyzing.desc.fridge')}
            </Text>
          </View>
        </View>
      )}
