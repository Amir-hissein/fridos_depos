    ...
    <View style={[styles.container, { paddingTop: insets.top + 8 }]}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>
          {loading
            ? t('scan.results.loadingTitle')
            : t('scan.results.title', { count: detected.length })}
        </Text>
      ...
      {loading ? (
        ...
        >
          ...
          {suggestions.length > 0 && (
            <FadeInItem index={detected.length + 1} style={styles.ideas}>
              ...
              <Text style={styles.ideasSub}>
                {t('scan.results.mealIdeas.subtitle', {
                  diet: t(`setup.diets.${profile.diet}` as 'setup.diets.healthy', {
                ...
                >
                  ...
                  <View style={styles.ideaBody}>
                    ...
                    <View
                      style={[
                        styles.matchBadge,
                        own.tag === 'complete' ? styles.matchGreen : styles.matchOrange,
                      ]}
                    >
                      <Ionicons
      ...
      <FadeInItem
        index={3}
        direction="none"
        style={[styles.actions, { paddingBottom: Math.max(insets.bottom, 12) }]}
      >
        <Button
          variant="primary"
