      ...
      <ScrollView contentContainerStyle={styles.activeContent} showsVerticalScrollIndicator={false}>
        ...
        <FadeInItem index={0}>
          ...
          >
            ...
            <Text style={styles.activeSubtitle}>{t('pro.active.subtitle')}</Text>
          </LinearGradient>
        </FadeInItem>
        ...
        <FadeInItem index={1}>
          <View style={styles.perksCard}>
            ...
            {FEATURES.map((f, i) => (
              <View
                key={f.key}
                style={[styles.perkRow, i < FEATURES.length - 1 && styles.perkBorder]}
              >
        ...
        <FadeInItem index={3}>
          <PressableScale style={styles.manageBtn} scaleTo={0.97} haptic="light" onPress={onManage}>
...
export default function ProScreen() {
  ...
  const subscribe = async () => {
    ...
    try {
      ...
      toast(
        t(
          e?.message === 'subscription_unavailable'
            ? 'pro.paywall.unavailable'
            : 'pro.paywall.purchaseError',
        ),
        { variant: 'error' },
      );
    } finally {
  ...
  const trustLabels = [t('pro.trust.secure'), t('pro.trust.noCharge'), t('pro.trust.cancel')];
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            {isTrialActive && (
              <View style={styles.trialPill}>
                ...
                <Text style={styles.trialPillText}>
                  {t('pro.trialBanner', { days: trialDaysLeft })}
                </Text>
              </View>
            )}
          </LinearGradient>
            ...
            >
              ...
              <View style={styles.planRowBody}>
                ...
                <Text style={styles.planRowSub}>
                  {t('pro.yearlyBilled', { total: t('pro.yearlyTotal', '$35.88') })}
                </Text>
              </View>
        ...
        <FadeInItem index={4}>
          ...
          <Text style={styles.ctaNote}>{t('pro.trialNote', { price })}</Text>

          <View style={styles.trustRow}>
            {(
              ['shield-checkmark-outline', 'card-outline', 'refresh-circle-outline'] as IName[]
            ).map((icon, i) => (
              <View key={i} style={styles.trustItem}>
                <Ionicons name={icon} size={14} color={colors.textMuted} />
                <Text style={styles.trustText}>{trustLabels[i]}</Text>
              </View>
            ))}
          </View>
