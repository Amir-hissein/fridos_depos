        ...
        <FadeInItem index={0}>
          <Animated.View style={[s.profileCard, { transform: [{ translateX: shakeAnim }] }]}>
            <View style={s.profileTop}>
              ...
              {!isEditing && (
                <PressableScale haptic="light" style={s.editBtn} onPress={startEdit} activeOpacity={0.8}>
          ...
          {isPremium ? (
            ...
            <View style={s.upsellCard}>
              ...
              <View style={s.crownWrap}>
                ...
                <MaterialCommunityIcons name="star" size={22} color={colors.surface} style={s.crownStar} />
              </View>
