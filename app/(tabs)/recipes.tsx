        ...
        <View style={styles.header}>
          ...
          <View
            style={[
              ...
              searchOpen
                ...
                : { width: contentWidth - 44 - 12, marginRight: 12 },
            ]}
          >
            <Animated.View
              style={{
          ...
          <View
            style={[
              ...
              searchOpen
                ? { width: contentWidth - 75 - 12, marginRight: 12 }
                : { width: 44, marginRight: 0 },
            ]}
          >
            <TouchableOpacity
              activeOpacity={0.85}
            ...
            >
              ...
              >
                ...
                <TextInput
                  ref={searchRef}
                  style={[styles.searchInput, !searchOpen && { width: 0, opacity: 0 }]}
          ...
          {/* Cancel Button */}
          <View style={[styles.cancelBtnContainer, searchOpen ? { width: 75 } : { width: 0 }]}>
        ...
        {anyFilterActive && (
          <View style={styles.activeFiltersRow}>
            {mealActive && (
              ...
              >
                <Text style={styles.activeChipText}>
                  {t('recipes.meals.' + selectedMealFilter)}
                </Text>
            ...
            {dietActive && (
              ...
              >
                <Text style={styles.activeChipText}>
                  {t('recipes.diets.' + selectedDietFilter)}
                </Text>
                <Ionicons name="close" size={14} color={colors.textSecondary} />
              </PressableScale>
            )}
          ...
          {isResultsMode ? (
            <View style={styles.resultsWrap}>
              <Text style={styles.resultsCount}>
                {results.length > 0
                  ? t('recipes.foundCount', { count: results.length })
                  : t('recipes.notFound')}
              </Text>
              {results.length === 0 ? (
            ...
            <>
              ...
              {CATEGORY_LISTS_BEFORE_CAL.map((cat, idx) => {
                ...
                const recipesForCat =
                  cat.key === 'sana-uygun'
                    ...
                    : RECIPES.filter(
                        (r) =>
                          r.categories?.includes(cat.key as any) &&
                          (!hideAllergens || !recipeHasUserAllergen(r, userAllergens)),
                      );
              ...
              {CATEGORY_LISTS_AFTER_CAL.map((cat, idx) => {
                const recipesForCat = RECIPES.filter(
                  (r) =>
                    r.categories?.includes(cat.key as any) &&
                    (!hideAllergens || !recipeHasUserAllergen(r, userAllergens)),
                );
            ...
            >
              ...
              <View style={styles.filterSection}>
                <Text style={styles.filterSectionTitle}>
                  {t('recipes.filterModal.mealSelection')}
                </Text>
              ...
              <View style={styles.filterSection}>
                <Text style={styles.filterSectionTitle}>
                  {t('recipes.filterModal.calorieRange')}
                </Text>
                <View style={styles.filterPillsContainer}>
            ...
            <View style={[styles.modalFooter, { paddingBottom: Math.max(insets.bottom, 16) }]}>
              ...
              >
                <Text style={styles.modalApplyBtnText}>
                  {anyFilterActive
                    ? t('recipes.filterModal.showRecipesCount', { count: results.length })
                    : t('recipes.filterModal.showRecipes')}
                </Text>
              </PressableScale>
            </View>
          </View>
