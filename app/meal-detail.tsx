...
export default function MealDetailScreen() {
  ...
  const handleSaveRecipe = () => {
    ...
    haptic.success();
    const recipeKcal = parseInt(newRecipeKcal, 10) || 300;
      ...
      <Modal visible={isCreateRecipeOpen} transparent={false} animationType="slide">
        <SafeAreaView style={styles.createRecipeSafe}>
          ...
          >
            ...
            <View style={styles.photoPickerSection}>
              <View style={styles.photoPickerLabelRow}>
                <Text style={styles.photoPickerTitle}>Tarif fotoğrafı ekle</Text>
              ...
              >
                ...
                <Text style={styles.photoPickerText}>Dokun ve fotoğraf seç</Text>
                <Text style={styles.photoPickerSubtext}>Galeri veya kameradan</Text>

                <View style={styles.photoCropCapsule}>
                  <Text style={styles.photoCropText}>Otomatik 16:9 kırpılır</Text>
                </View>
              </TouchableOpacity>
            </View>

            {/* Ingredients / Prep Tabs */}
            ...
            {/* Dummy fields for calories so it can be logged */}
            <View style={{ marginTop: 24, gap: 10 }}>
              <Text style={styles.photoPickerTitle}>Tarif Kalorisi (kcal)</Text>
              <TextInput
                style={styles.recipeNameInput}
                placeholder="Kalori değeri (örn: 350)"
                placeholderTextColor={Colors.textMuted}
                keyboardType="numeric"
                value={newRecipeKcal}
          ...
          <View style={styles.saveButtonContainer}>
            ...
            >
              <MaterialCommunityIcons name={"content-save" as any} size={20} color="#1A1E1C" />
