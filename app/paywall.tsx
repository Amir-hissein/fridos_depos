...
export default function PaywallScreen() {
  ...
  // Content fade is mount-driven (shared value) so it always resolves to visible —
  // a native-driver fade could silently fail to start and leave the paywall blank.
  ...
  return (
    <View style={styles.container}>
      <LinearGradient
        colors={[colors.surfaceGreen, colors.background]}
        ...
        >
          ...
          <View style={styles.features}>
            {FEATURES.map((f, idx) => (
              <View
                key={idx}
                style={[styles.featureRow, idx < FEATURES.length - 1 && styles.featureRowBorder]}
              >
          ...
          <View style={styles.plans}>
            ...
            >
              ...
              <Text
                style={[styles.planLabel, selectedPlan === 'monthly' && styles.planLabelActive]}
              >
                {t('pro.monthly')}
              </Text>
              <Text
