    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      >
        ...
        <FadeInItem index={1} style={s.infoSection}>
          ...
          <Text style={s.paragraph}>{t('profile.bmiPage.description')}</Text>
        </FadeInItem>
        ...
        <FadeInItem index={2} style={s.infoSection}>
          ...
          <View style={s.rangeList}>
            <StatRow
              ...
              label={t('profile.bmi.categories.underweight')}
              value="0 – 18.4"
            />
            <StatRow
              icon="check-circle-outline"
              label={t('profile.bmi.categories.healthy')}
              value="18.5 – 24.9"
              valueAccent
            />
            <StatRow
              icon="alert-outline"
              label={t('profile.bmi.categories.overweight')}
              value="25.0 – 29.9"
            />
            <StatRow
              icon="alert-circle-outline"
              label={t('profile.bmi.categories.obese')}
              value="30.0+"
            />
          </View>
        </FadeInItem>
