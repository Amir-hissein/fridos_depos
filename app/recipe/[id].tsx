...
export default function RecipeDetailScreen() {
  ...
  // Mount-driven (shared value) rather than an `entering`/native-driver animation
  // so the content ALWAYS resolves to visible — the previous native-driver fade
  // could silently fail to start on the New Architecture, leaving the screen blank.
  ...
  const heroStyle = useAnimatedStyle(() => ({
    transform: [{ scale: 1.1 - 0.1 * entrance.value }],
  }));
  const contentStyle = useAnimatedStyle(() => ({
    opacity: entrance.value,
    transform: [{ translateY: 28 * (1 - entrance.value) }],
  }));
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.hero, { backgroundColor: recipe.bgColor }]}>
          <Animated.Text style={[styles.heroEmoji, heroStyle]}>{recipe.emoji}</Animated.Text>
          {showImage && (
            <Animated.Image
        ...
        <Animated.View style={[styles.sheetBody, contentStyle]}>
          <View style={styles.titleHeader}>
            <Text style={styles.recipeName}>{loc.name}</Text>
            <View style={styles.timeBadge}>
              <Ionicons name="time-outline" size={14} color={colors.textSecondary} />
              <Text style={styles.timeText}>
                {recipe.time} {t('plan.min')}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tabContentArea}>
                    ...
                    <View key={idx}>
                      <View style={styles.ingRow}>
                        ...
                        >
                          ...
                          />
                          <Text style={[styles.ingName, !owned && { color: colors.textSecondary }]}>
                            {ing.name}
                          </Text>
                        </View>
            ...
            {isLocked && (
              <BlurView intensity={45} tint="dark" style={styles.premiumBlur}>
                <View style={styles.premiumOverlayContainer}>
                  ...
                  <PressableScale
                    ...
                    activeOpacity={0.8}
                  >
                    <Text style={styles.premiumBtnText}>{t('recipes.details.premiumJoin')}</Text>
                  </PressableScale>
                </View>
              </BlurView>
            )}
        ...
        <View style={styles.sheetHeader}>
          <View style={styles.sheetHeaderText}>
            ...
            <Text style={styles.sheetSubtitle}>
              {loc.name} · 🕒 {recipe.time} {t('plan.min')}
            </Text>
          </View>
          <PressableScale
            haptic="light"
            ...
            return (
              ...
              >
                <View style={styles.mealOptionLeft}>
                  ...
                  />
                  <Text style={[styles.mealOptionText, isActive && styles.mealOptionTextActive]}>
                    {t('recipes.meals.' + meal)}
                  </Text>
                </View>
