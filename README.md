...
Business logic is isolated from the UI and **tested**: `services/` (pure functions — BMR, macros, insights, fridgerecipe matching) · `components/` (presentation) · `context/` (state per domain) · `app/` (Expo Router screens) · `supabase/` (SQL schema + Edge Functions).
...
> Mostly tested on **iOS** — validate a full **Android** build before shipping.

<div align="center"><br/>

Built by **Amir Hissein**
