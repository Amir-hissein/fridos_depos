    ...
    <PressableScale style={styles.card} onPress={onPress} scaleTo={0.98} haptic="light">
      ...
      <View style={[styles.badge, tag === 'complete' ? styles.badgeGreen : styles.badgeOrange]}>
        ...
        <Text style={styles.badgeText}>
          {tag === 'complete'
            ...
            : t('recipes.card.missingCount', { count: missingCount })}
        </Text>
      </View>
      ...
      <View style={styles.bottom}>
        ...
        <View style={styles.metaRow}>
          ...
          <Text style={styles.metaDivider}>•</Text>
          <Text style={styles.metaText}>
            {t('setup.paces.' + mapDifficulty(recipe.difficulty))}
          </Text>
        </View>
      </View>
...
export function RecipeCardB({ recipe, onPress, warnAllergen }: RecipeCardProps) {
  ...
  return (
    <PressableScale style={styles.cardB} onPress={onPress} scaleTo={0.95} haptic="light">
      ...
      <View style={styles.badgeB}>
        <Text style={styles.badgeTextB}>
          {recipe.mealType
            ? t('recipes.meals.' + mapMealTypeKey(recipe.mealType))
            : t('recipes.card.recipeFallback')}
        </Text>
      </View>
      ...
      <View style={styles.bottomB}>
        <Text style={styles.nameB} numberOfLines={2}>
          {localizeRecipeName(recipe, t)}
        </Text>
...
export function RecipeCardC({ recipe, onPress, warnAllergen }: RecipeCardProps) {
  ...
  return (
    <PressableScale style={styles.cardC} onPress={onPress} scaleTo={0.96} haptic="light">
      ...
      <View style={styles.bottomC}>
        <Text style={styles.nameC} numberOfLines={1}>
          {localizeRecipeName(recipe, t)}
        </Text>
...
export function RecipeCardD({ recipe, onPress, warnAllergen }: RecipeCardProps) {
  ...
  return (
    <PressableScale style={styles.cardD} onPress={onPress} scaleTo={0.96} haptic="light">
      ...
      <View style={styles.bottomD}>
        <Text style={styles.nameD} numberOfLines={2}>
          {localizeRecipeName(recipe, t)}
        </Text>
      </View>
